# CentOS/RHEL 7 Minimal ISO를 이용한 설치
...
> [http://mirror.oops.org/pub/AnNyung/3/inst/AnNyung.ks](http://mirror.oops.org/pub/AnNyung/3/inst/AnNyung.ks) [http://ftp.kr.freebsd.org/pub/AnNyung/3/inst/AnNyung.ks](http://ftp.kr.freebsd.org/pub/AnNyung/3/inst/AnNyung.ks)
...
또한, 설치 후, 작업을 별도로 해야 하기 때문에 될 수 있으면, Network Install ISO를 이용하여 설치하는 방법을 권장 합니다.
...
다음의 설명은 일반적인 CentOS 7이나 RHEL 7의 설치와 동일하며, 안녕 설치를 좀 더 깔끔하게 할 수 있는 옵션 설정을 제공 합니다.

## 1. CDROM 또는 USB 부팅

![&#xBD80;&#xD305;&#xD654;&#xBA74;](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_12_35.png)

처음 부팅을 하고 Install가 실행이 되면 위와 같은 화면이 나오게 됩니다. 화살표 키 또는 탭키를 이용하여 **Install CentOS 7**을 선택 한 후에 엔터를 실행합니다.

## 2. 언어 선택

![&#xC5B8;&#xC5B4;&#xC120;&#xD0DD;](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_14_08.png)

편안한 언어를 선택 하시면 됩니다.

## 3. 기본 설치 화면

![&#xAE30;&#xBCF8; &#xC124;&#xCE58; &#xD654;&#xBA74;](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_14_50.png)

언어 선택에서 한국어를 선택하였다면, 위의 이미지와 같이 되어 있을 겁니다. 만약 다른 언어를 선택하였다면, 시간 설정과 키보드, 언어지원등의 설정을 직접 원하시는 대로 해 주시면 됩니다.

안녕 리눅스 설치를 위해서는, 기본적으로 _**디스크 파티션**_ 과 _**네트워크 설정**_, _**KDUMP**_만 비활성화 해 주시면 됩니다.
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_15_22.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_16_51.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_17_07.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_17_47.png)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_18_56.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_25_17.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_25_32.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_25_55.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_26_16.png)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_18_09.png)

비활성화 하도록 합니다.

## 7. 설치 시작

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_18_27.png)

여기까지 진행이 되었다면, 위의 이미지와 같이 우측 하단의 **설치 시작\(B\)** 버튼이 푸른색으로 활성화가 됩니다. 이 **설치 시작\(B\)** 버튼을 클릭하면 아래의 이미지와 같이 설치가 시작이 됩니다.

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_26_37.png)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_28_01.png)

**참고!!** 주의할 것은, 생성한 일반 유저는 최초 접속시에 무조건 암호를 변경 되도록 되어 있습니다. 이는 ISMS 보안 심사를 위한 설정에 의하여 적용된 사항이므로, 다른 배포본과의 차이 입니다.

## 8. 설치 완료 및 재부팅

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_31_30.png)

좌측 하단의 **재부팅\(R\)** 버튼이 푸른색으로 활성화가 되면, 클릭하여 리부팅을 합니다.

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_31_53.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_32_26.png)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_17_45_52.png)

로그인을 한 후, 위의 이미지처럼 안녕 리눅스 bootstrap 파일을 다운로드 받아서 실행을 합니다. 안녕 리눅스의 bootstrap 파일은 다음의 URL에서 받을 수 있습니다.

> [http://mirror.oops.org/pub/AnNyung/3/inst/bootstrap](http://mirror.oops.org/pub/AnNyung/3/inst/bootstrap)  
>  [http://ftp.kr.freebsd.org/pub/AnNyung/3/inst/bootstrap](http://ftp.kr.freebsd.org/pub/AnNyung/3/inst/bootstrap)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_17_49_29.png)
...
2. LANG 환경 변수를 **ko\_KR.UTF-8** 로 설정 합니다.
...
6. IPv6 설정을 제거 합니다. IPv6 환경을 사용하신다면, bootstrap 파일에서 no\_ipv6\_off 라인을 주석 처리 하십시오.
...
12. 기본 방화벽인 firewalld 를 제거하고 oops-firewall을 설치 합니다.
    ...
    2. [http://oops.org/?t=lecture&sb=firewall&n=2](http://oops.org/?t=lecture&sb=firewall&n=2) 문서 참조
...
![grub2 booting list](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_17_49_43.png)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_17_50_07.png)

**/etc/issue**의 banner가 **AnNyung LInux**로 변경이 되었으며, 콘솔 해상도가 1024\*768로 변경이 되었습니다.

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_17_50_54.png)

ethernet 이름이 다시 **eth**로 변경이 되었으며, 최초 설치 사이즈는 1.3Gbyte 입니다.

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_17_51_50.png)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_17_52_20.png)
