# CentOS/RHEL 7 Network Install ISO를 이용한 설치
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_19_04_29.png)

안녕 리눅스의 kickstart 설정으로 위의 이미지의 붉은 박스 안에 표시된 "_**설치 대상\(D\)**_" 의 disk partioning만 해 주시면 됩니다.

"_**네트워크 및 호스트명\(N\)**_"에 표기된 ethernet deivce 이름이 "**enp0s3**"과 같이 표기 되어 있더라도 안녕 리눅스는 설치 후 ehternet device이름을 이전 버전에서 처럼 "**eth**"로 사용하도록 변경을 하오니 참고 하시기 바랍니다.
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_15_22%20%281%29.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_16_51%20%281%29.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_17_07%20%281%29.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_19_06_21.png)

파티셔닝이 완료가 좌측 하단의 푸른색 "_**설치 시작\(B\)**_" 버튼을 클릭하여 설치를 시작 합니다.

**주의**: disk가 여러개일 경우에는 booting partion 설정에 주의하십시오.

## 4. 설치

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_19_06_37.png)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_28_01%20%281%29.png)

**참고!!** 주의할 것은, 생성한 일반 유저는 최초 접속시에 무조건 암호를 변경 되도록 되어 있습니다. 이는 ISMS 보안 심사를 위한 설정에 의하여 적용된 사항이므로, 다른 배포본과의 차이 입니다.

## 5. 설치 완료 및 재부팅

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_16_31_30%20%281%29.png)

좌측 하단의 **재부팅\(R\)** 버튼이 푸른색으로 활성화가 되면, 클릭하여 리부팅을 합니다. AnNyung.ks 를 이용하여 설치하는 경우, 설치가 완료가 되면 자동으로 재시작 하도록 되어 있어 이 화면은 띄지 않을 수도 있습니다.

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_19_16_24.png) ![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_19_16_53.png)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_19_17_46.png)

ethernet 이름이 다시 **eth**로 변경이 되었으며, 최초 설치 사이즈는 1.1Gbyte 입니다.

![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_19_18_12.png)
...
![](.gitbook/assets/VirtualBox_AnNyung3_22_01_2016_19_18_39.png)
